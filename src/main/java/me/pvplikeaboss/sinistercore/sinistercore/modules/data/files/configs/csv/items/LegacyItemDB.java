...
import me.pvplikeaboss.sinistercore.sinistercore.utilites.typeutils.ReflUtil;
...
import static me.pvplikeaboss.sinistercore.sinistercore.utilites.misc.Misc.tl;
...
public class LegacyItemDB extends AbstractItemDB {
    ...
    public LegacyItemDB(final SinisterCore plugin) {
        super(plugin);
    ...
    public ItemStack get(final String id, final boolean useResolvers) throws Exception {
        ...
        utilMsgs.logInfoMessage("Stage 0: itemid["+itemid+"] | itemname["+itemname+"]");
        ...
        utilMsgs.logInfoMessage("Stage 1: itemid["+itemid+"] | itemname["+itemname+"]");
        ...
        utilMsgs.logInfoMessage("Stage 2: itemid["+itemid+"] | itemname["+itemname+"]");
        ...
        utilMsgs.logInfoMessage("Stage 3: itemid["+itemid+"] | itemname["+itemname+"] | Material["+mat.toString()+"]");
        ...
        if (nbtData.containsKey(itemname)) {
            ...
            retval = plugin.getServer().getUnsafe().modifyItemStack(retval, nbt);
        }
        ...
        if (mat == MOB_SPAWNER) {
            ...
            //retval = plugin.getSpawnEggProvider().createEggItem(type);
            ...
            //retval = plugin.getPotionMetaProvider().createPotionItem(mat, metaData);
        } else {
