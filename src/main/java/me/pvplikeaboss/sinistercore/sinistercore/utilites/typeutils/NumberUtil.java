...
public final class NumberUtil {
    ...
    public static String shortCurrency(final BigDecimal value, final SinisterCore plugin) {
    ...
    public static String displayCurrency(final BigDecimal value, final SinisterCore plugin) {
        ...
        */
        return sign+tl("currency", "$", currency);
    }

    public static String displayCurrencyExactly(final BigDecimal value, final SinisterCore plugin) {
    ...
    public static String sanitizeCurrencyString(final String input, final SinisterCore plugin) {
